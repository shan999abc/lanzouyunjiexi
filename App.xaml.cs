...
namespace TEST
{
    ...
    public partial class App : Application
    {
        ...
        {
            static readonly Dictionary<string, Assembly> Dlls = new Dictionary<string, Assembly>();
            static readonly Dictionary<string, object> Assemblies = new Dictionary<string, object>();
            ...
            static Assembly AssemblyResolve(object sender, ResolveEventArgs args)
            {
                ...
                if (Dlls.TryGetValue(assName, out Assembly ass) && ass != null)
                {
